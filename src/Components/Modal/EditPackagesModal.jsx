...
const EditPackagesModal = ({isEditOpen, setIsEditOpen, editPackage, services, refetch}) => {
   const axiosSecure = useAxiosSecure();
    ...
    const handleEditPackage = async(data)=>{
     ...
     return {
      ...
      const res = await axiosSecure.patch(`/packages/${editPackage._id}`, updateData)
                                         ...
                                         <div className='grid grid-cols-2  gap-2 max-h-40 overflow-y-auto border p-2 rounded'>
                                        {
                                            services.map(service=> (
                                                <label key={service._id} className='flex gap-2'>
                                                    <input type="checkbox" {...register(`services.${service._id}`)} />
                                          ...
                                          <div className='flex justify-end gap-2 pt-4'>
                                              <button type='submit' className='btn bg-primary text-white hover:bg-secondary'>Update Package</button>

    ...
    <Transition show={true} as={Fragment}>
      <Dialog as="div" className="relative z-50" onClose={close}>
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          ...
          >
            <DialogPanel className="bg-base-100 w-full max-w-md rounded-xl p-6 shadow-lg">
              <DialogTitle className="text-xl font-semibold mb-4 text-primary">
                Book {service.service_name}
              </DialogTitle>
              <form
                onSubmit={handleSubmit(handleBookingDecoration)}
                className="space-y-4"
              >
                {/* user name */}
                <div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 bg-primary hover:bg-secondary btn text-white font-medium rounded-md"
                  >
                  ...
                  <button
                    type="button"
                    onClick={close}
                    className="flex-1 bg-gray-700 hover:bg-gray-500 btn text-white font-medium rounded-md"
                  >
                    Cancel
                  </button>
                </div>

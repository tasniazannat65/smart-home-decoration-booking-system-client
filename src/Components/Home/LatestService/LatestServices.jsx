    ...
    <div className="pt-6 md:pt-8 lg:pt-12">
      <Container>
        <div className="max-w-4xl mx-auto mb-8">
          <Heading
            title="Our Top Decoration Services"
            subtitle="Explore premium decoration packages for weddings, birthdays, homes, and offices."
            center
          />
        </div>
        ...
        <Link to="/services" className="flex justify-center  mt-8 ">
          <button className="relative inline-flex items-center justify-center p-[5px] overflow-hidden font-semibold text-white  cursor-pointer transition-all duration-300 bg-gradient-to-r from-primary via-secondary  to-primary rounded-lg active:scale-90 hover:shadow-lg shadow-xl shadow-secondary/30">
            <span className="w-full h-full bg-primary transition-all duration-300 hover:bg-transparent px-10 py-3 rounded-md flex items-center gap-1">
              View All Services

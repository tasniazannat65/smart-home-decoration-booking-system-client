    ...
    <div className="pt-6 md:pt-8 lg:pt-12">
      <div className="mb-8">
        <Heading
          ...
          subtitle="From weddings to corporate events, see how far our expertise reaches."
          center
        />
      </div>
      ...
      <Link className="flex items-center justify-center" to="/coverage">
        <button className="btn bg-primary text-white rounded-md mt-8 hover:bg-secondary ">
          View full Coverage
        </button>
      </Link>
    </div>

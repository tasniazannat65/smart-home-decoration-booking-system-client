...
const Footer = () => {
  return (
    <footer className="bg-base-300 mt-10 pt-10 pb-6">
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-base-300 pb-6">
          ...
          <div className="flex gap-4 mt-4 md:mt-0">
            <a
              href="#"
              className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-primary to-secondary text-white hover:scale-110 transition-transform"
            >
              <FaFacebookF />
            </a>
            <a
        ...
        <div className="mt-10 text-center text-neutral text-md border-t border-base-100 ">
          <p className="mt-5"> © {new Date().getFullYear()} Laxius Decor. All Rights Reserved.</p>
        </div>
      </Container>
    </footer>
  );

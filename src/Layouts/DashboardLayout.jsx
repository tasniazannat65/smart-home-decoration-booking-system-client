        ...
        <div className="flex min-h-screen flex-col bg-base-300 is-drawer-close:w-28 is-drawer-open:w-64">
          ...
          <ul className="menu w-full flex-1">
            ...
            <li>
              <Link
                to="/dashboard"
                className="is-drawer-close:tooltip hover:bg-secondary hover:text-white text-primary font-semibold text-lg is-drawer-close:tooltip-right"
                data-tip="Homepage"
              >
                {/* Home icon */}
                <svg

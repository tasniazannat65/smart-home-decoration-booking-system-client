    ...
    <div className="space-y-8 p-6 md:p-8 lg:p-10">
      ...
      <div className="flex flex-col md:flex-row lg:flex-row justify-between items-center gap-4">
        ...
        <Link
          ...
          className="px-6 py-2 bg-primary rounded-md text-white hover:bg-secondary shadow"
        >
          Edit Profile
        </Link>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ">
        ...
        />
        <Card icon={<FaCheckCircle />} value={completed} label="Completed" />
        <Card icon={<FaTimesCircle />} value={cancelled} label="Cancelled" />
      </div>
    </div>
  );
};

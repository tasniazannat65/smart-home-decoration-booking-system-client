    ...
    <div className="text-accent">
      ...
      <section className="relative h-96 md:h-[500px] lg:h-[600px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-center text-white px-4">
          ...
          <Link
            to="/services"
            className="btn bg-primary border-none hover:bg-secondary text-white px-6 py-2 rounded-md"
          >
            Explore Services
          </Link>
        </div>
      ...
      <Container>
        <section className="pt-8 md:pt-12 lg:pt-14 flex flex-col md:flex-row lg:flex-row items-center gap-8">
          <img
           ...
           lg:w-1/2 rounded-xl shadow-lg object-cover hover:scale-105 transition-transform duration-300"
          />
          <div className="md:w-1/2 lg:w-1/2">
            <Heading title="About Laxius Decor" />
            <p className="text-neutral mb-1">
              {" "}
              At Laxius Decor, we create memorable events tailored to your
              needs. Our experienced team ensures every detail is perfect, from
              decoration to ambience.
            </p>
            <p className="text-neutral">
              {" "}
              Our mission is to transform your vision into reality, making each
              celebration unique and unforgettable.
            </p>
          </div>
        </section>
        <section className="grid md:grid-cols-2 lg:grid-cols-2 grid-cols-1 gap-12 pt-8 md:pt-12 lg:pt-14">
          <div className="bg-primary/10 rounded-xl p-8 shadow-lg hover:shadow-xl transition duration-300">
            ...
            <p className="text-neutral">
              ...
              experiences through exceptional home and event decoration
              services. We strive for perfection in every detail, ensuring your
              special moments are unforgettable.
            </p>
          </div>
          <div className="bg-secondary/10 rounded-xl p-8 shadow-lg hover:shadow-xl transition duration-300">
            ...
            <p className="text-neutral">
              {" "}
              Our vision is to be the leading home and event decoration service,
              recognized for creativity, reliability, and customer satisfaction.
              We aim to inspire beauty and elegance in every space we touch.
            </p>
          </div>
        </section>
      </Container>
      <section className="pt-8 md:pt-12 lg:pt-14 bg-base-100 text-center">
          ...
          {[
            {
              ...
              desc: "Unique decor ideas for every occasion.",
            },
            {
              img: clock,
              title: "Timely Delivery",
              desc: "On-time execution for smooth events.",
            },
            {
              img: money,
              title: "Affordable Packages",
              desc: "Premium services within your budget.",
            },
            {
              img: person,
            ...
            <div
              key={index}
              className="group bg-primary/10 p-8 rounded-xl shadow-md hover:shadow-xl transition duration-300 hover:-translate-y-2 "
            >
      ...
      <section className="pt-8 md:pt-12 lg:pt-14 bg-base-100 px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-10 mt-5">
          {[
            ...
            <div
              key={index}
              className="bg-primary/10 rounded-xl shadow-md hover:shadow-xl transition overflow-hidden group"
            >
              ...
              <div className="p-6 text-center">
                ...
                <span
                  className="inline-block mt-2
                   py-1 px-4  text-sm rounded-full bg-primary/10 text-primary"
                >
                  {member.role}
                </span>
              </div>
      ...
      <section className="relative mt-8 md:mt-12 lg:mt-14 text-white text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto py-8 md:py-12 lg:py-14">
          ...
          <p className="text-[16px] lg:text-lg mb-10 opacity-90">
            {" "}
            Let Laxius Decor bring elegance, creativity and perfection to your
            special day.
          </p>
          <button className="px-10 py-4 bg-base-100 text-primary font-semibold rounded-full hover:scale-105 transition duration-300 shadow-lg">
            Book Your Event Now
          </button>
        </div>
      </section>

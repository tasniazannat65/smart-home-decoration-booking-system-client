...
const Contact = () => {
  return (
      ...
      <img src={image} alt="Person" className=' lg:absolute md:absolute lg:top-16 md:top-16 shadow-xl lg:left-[490px] md:left-96 lg:h-[500px] md:h-[300px]' />

        <div className='w-full p-6 md:p-12 lg:p-16 flex justify-center items-center md:absolute lg:absolute z-30 lg:top-36 md:top-28 lg:right-80 md:right-40'>
      ...
      <section className='bg-gradient-to-r from-primary/90 to-secondary/80 text-white lg:py-8 py-5 md:absolute lg:absolute md:top-[560px] lg:top-[600px] lg:left-[600px] md:left-[250px] z-50 lg:px-10 px-6 shadow-xl'>

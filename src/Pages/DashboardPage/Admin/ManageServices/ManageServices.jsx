...
const ManageServices = () => {
  ...
  const { data, refetch, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosSecure.get("/services", {
        params: { admin: true, search, category, page, limit },
      });
      return res.data;
    },
  });
  ...
  return (
    <div>
      ...
      <Tabs>
        <TabList className="flex border-b-2 border-base-300 mb-4">
          <Tab
            className="text-primary px-4 py-2 cursor-pointer font-medium "
            selectedClassName="border-b-2 border-primary text-secondary"
          >
            Services
          </Tab>
          <Tab
          ...
          <div className="p-4 bg-base-100 shadow rounded-lg">
            ...
            <div className="mb-4 flex gap-2">
              ...
              <select
                ...
                className="border border-gray-300 rounded px-2 py-1 shadow-sm bg-base-100  focus:ring-2 focus:ring-primary focus:outline-none transition duration-300 ease-in-out hover:shadow-md  "
              >

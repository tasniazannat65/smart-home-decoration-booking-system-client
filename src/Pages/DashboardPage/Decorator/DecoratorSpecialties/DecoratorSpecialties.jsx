    ...
    return (
        <div className='bg-base-100 p-6 rounded-xl shadow'>
            <div className='mb-4'>
                ...
                <p className='text-lg font-bold flex items-center gap-1'>{decoratorRating} <FaStar className='text-orange-400' />
 </p>
            ...
            <div className='grid grid-cols-2 gap-3'>
                {
                    all_specialties.map(s => (
                        <label key={s} className='flex gap-2 items-center'>
                            <input type="checkbox" className="checkbox checkbox-primary" checked={selected.includes(s)} onChange={()=> toggleSpecialties(s)} />
                            {s}
            ...
            <button onClick={handleSpecialties}
